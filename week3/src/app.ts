...
export class Koala implements Marsupial {
    ...
    constructor(public habitat: String, public dietType: String, public avgWeight: number, public avgLength: number) {
        this.species = "Koala";
...
const koala = new Koala("Eucalyptus forests of Southeastern and Eastern Australia", "Herbivore", 35, 32);
